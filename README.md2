...
To ensure that the website is up-to-date with the latest data, real-time data is collected using various websites. The data collection programs are also included in this repository, although to save on resources and time, data collection is stopped , the database would need to be updated with correct cryot data from the previous 2 and a half months.
